    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <table className="w-full text-sm">
                <thead className="bg-gray-50 dark:bg-gray-700/50">
                  <tr>
                    ...
                    <th className="text-right py-2 px-3 font-medium text-gray-700 dark:text-gray-300 w-24">Qty</th>
                    <th className="text-right py-2 px-3 font-medium text-gray-700 dark:text-gray-300 w-28">Unit Price</th>
                  ...
                  {lines.map((line, i) => {
                    ...
                    return (
                      <tr key={i} className="border-t border-gray-200 dark:border-gray-600">
                        ...
                        <td className="py-1 px-3 text-right font-mono text-gray-700 dark:text-gray-300">
          ...
          <div className="py-3 px-4 rounded-lg bg-gray-50 dark:bg-gray-700/50 space-y-1 text-sm">
